...
PATH_TO_DB = 'sqlite:///model_selection/models/optuna_study.db'
...
#Stacking RF ensemble
meta_rf = RandomForestClassifier(n_estimators=1000, random_state=42, max_depth=50, n_jobs=-1)
